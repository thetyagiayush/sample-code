...
import OtpInput from "../Host/OtpInput";

function BusinessInfoFormAdv({
  ...
  return (
    <div className="w-full mt-[3rem]">
      ...
      <div className="w-full mt-[4rem]">
        <GradientButton text="Next" additionalCss="w-full !py-2" onClick={handleClick} />
      </div>
    </div>
  );
}

export default BusinessInfoFormAdv;